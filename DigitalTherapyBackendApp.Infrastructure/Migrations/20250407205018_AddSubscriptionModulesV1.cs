...
{
    /// <inheritdoc />
    public partial class AddSubscriptionModulesV1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseCurrency = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    ...
                    MoodEntryLimit = table.Column<int>(type: "integer", nullable: false),
                    AIChatSessionsPerWeek = table.Column<int>(type: "integer", nullable: false),
                    MessageLimitPerChat = table.Column<int>(type: "integer", nullable: false),
                    HasPsychologistSupport = table.Column<bool>(type: "boolean", nullable: false),
                    PsychologistSessionsPerMonth = table.Column<int>(type: "integer", nullable: false),
                    HasEmergencySupport = table.Column<bool>(type: "boolean", nullable: false),
                    HasAdvancedReports = table.Column<bool>(type: "boolean", nullable: false),
                    HasAllMeditationContent = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubscriptionTranslations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubscriptionTranslations_Subscriptions_SubscriptionId",
                        column: x => x.SubscriptionId,
                        principalTable: "Subscriptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionTranslations_SubscriptionId_LanguageCode",
                table: "SubscriptionTranslations",
                columns: new[] { "SubscriptionId", "LanguageCode" },
                unique: true);
