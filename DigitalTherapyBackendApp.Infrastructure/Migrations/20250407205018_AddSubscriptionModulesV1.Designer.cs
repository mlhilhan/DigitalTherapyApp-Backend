...
namespace DigitalTherapyBackendApp.Infrastructure.Migrations
{
    ...
    [Migration("20250407205018_AddSubscriptionModulesV1")]
    partial class AddSubscriptionModulesV1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DigitalTherapyBackendApp.Domain.Entities.DailyTip.DailyTipTranslation", b =>
                {
                    ...
                    b.HasIndex("TipId", "LanguageCode")
                        .IsUnique();

                    b.ToTable("DailyTipTranslations", (string)null);
                });
